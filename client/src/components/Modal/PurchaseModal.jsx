          ...
          <div className='flex min-h-full items-center justify-center p-4 text-center'>
            ...
            >
              <DialogPanel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
                ...
                <div className='mt-2'>
                  <div className=' text-sm'>
                    ...
                    <input
                      ...
                      className=' px-2 text-gray-800 border border-lime-300 focus:outline-lime-500 rounded-md bg-white'
                      name='quantity'
                      id='quantity'
                      type='number'
                ...
                <Button onClick={handlePruchase} label={`Pay${totalPrice}`}></Button>
              </DialogPanel>
            </TransitionChild>
          </div>
        </div>
